...
def setup_buttons():
    ...
    Button(main_window, text="Append Details",
           command=append_name) .grid(column=0, row=1)
    Button(main_window, text="Print Details",
           command=print_camp_details) .grid(column=1, row=1)
    ...
    Button(main_window, text="Delete",
           command=delete_row) .grid(column=2, row=6)
...
main()
# I am adding this line to test out another commit to
# Github
